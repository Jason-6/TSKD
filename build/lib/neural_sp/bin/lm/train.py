...
def main(args):
    ...
    train_set = Dataset(corpus=args.corpus,
                        ...
                        serialize=args.serialize, start_hk_epoch=args.start_hk_epoch)
    ...
    eval_sets = [Dataset(corpus=args.corpus,
                         ...
                         bptt=args.bptt,
                         backward=args.backward,
                         serialize=args.serialize, start_hk_epoch=args.start_hk_epoch) for s in args.eval_sets]
    ...
    if args.n_gpus >= 1:
        print(is_transformer, args.cudnn_benchmark, args.cudnn_deterministic, is_transformer, args.cudnn_benchmark)
        model.cudnn_setting(
