...
model=./data/results/aishell1/asr/train_sp/conv2Lblstm512H5L_sumfwdbwd_drop2_lstm1024H1L_location_ss0.2_adam_lr0.001_bs18000_ls0.1_warmup25000_accum8/model.epoch-53
model1=
model2=
model3=
model_bwd=
