...
model=./data/results/aishell1/asr/train_sp/conv2Lconformer256dmodel1024dff12L4Hkernel15_layer_norm_clamp10_max_pool8_lstm1024H1L_location_ss0.2_noam_lr5.0_bs18000_ls0.1_warmup25000_accum8_ctc0.8_27FM2_100TM2/model.epoch-60
model1=
model2=
model3=
model_bwd=
...
data=./data//data/results/aishell1/lm/train_sp/lstm1024H0P2L_emb1024_tie_residual_glu_adam_lr0.001_bs64_bptt200_dropI0.5H0.5_ls0.1/model.epoch-13
...
gnmt_decoding=false
eos_threshold=1.0
lm=./data/results/aishell1/lm/train_sp/lstm1024H0P2L_emb1024_tie_residual_glu_adam_lr0.001_bs64_bptt200_dropI0.5H0.5_ls0.1_1/model.epoch-9
lm_second=
lm_bwd=
lm_weight=0.2
