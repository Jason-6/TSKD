...
feature_data=/media/mgl/OS/data
model=./data/results/${corpus}

### path to the model directory to resume training
resume=data/results/aishell1/con_no_pretrain_log/asr/train_sp/conv2Lconformer256dmodel1024dff12L4Hkernel15_layer_norm_clamp10_max_pool8_lstm1024H1L_location_ss0.2_noam_lr5.0_bs18000_ls0.1_warmup25000_accum8_ctc0.9_27FM2_100TM2/model.epoch-56
lm_resume=

### path to save preproecssed data
data=/media/mgl/947E84AB7E848826/datasets/
...
if [ ${stage} -le 4 ] && [ ${stop_stage} -ge 4 ]; then
    ...
    export OMP_NUM_THREADS=${n_gpus}
    python \
        ${NEURALSP_ROOT}/neural_sp/bin/asr/plot_dec_attention.py --local_world_size=${n_gpus} \
        --corpus ${corpus} \
        --use_wandb ${use_wandb} \
        --config ${conf} \
        --config2 ${conf2} \
